...
package first.attempt.raspberry.plugin.impl.util;
...
public class DeviceTypeUtils {
    ...
    private static Log log = LogFactory.getLog(first.attempt.raspberry.plugin.impl.util.DeviceTypeUtils.class);
