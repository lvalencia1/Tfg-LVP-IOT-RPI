...
package first.attempt.raspberry.plugin.internal;

import first.attempt.raspberry.plugin.exception.DeviceMgtPluginException;
import first.attempt.raspberry.plugin.impl.util.DeviceTypeUtils;
import first.attempt.raspberry.plugin.impl.DeviceTypeManagerService;
...
/**
 * @scr.component name="first.attempt.raspberry.plugin.internal.ServiceComponent"
 * immediate="true"
 */
